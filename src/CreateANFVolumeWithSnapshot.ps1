...
# Setting up Export Policy properties {Rule Index, UnixReadOnly, UnixReadWrite, Cifs, Nfsv3, nfsv41, and Allowedclients}
...
# Assign the previously created Export Policy Rule to a new Export Policy object to assign to the Volume object
...
# Create Snapshot object to assign to the volume object
...
Write-Verbose -Message "The script has been successfully executed." -Verbose
